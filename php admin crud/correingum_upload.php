...
if(move_uploaded_file($notification_pdf_temp_name,$destination))
{
   if(empty($dated)||empty($notification_title)||empty( $notification_pdf)){
     ...
     $insert = "INSERT INTO `correingum` (`dated`,`notification_title`,`pdf_file`) VALUES ('$dated','$notification_title','$notification_pdf')";
...
if (isset($_GET['file_id'])) {
    ...
    $sql = "SELECT * FROM correingum WHERE sno=$id";

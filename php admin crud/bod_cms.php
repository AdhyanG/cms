...
session_start();
 ...
 if(isset($_POST['add_content'])){
  ...
  if(empty($name)||empty($designation)){
      ...
      $insert = "INSERT INTO `bod` (`name`,`designation`,`position`) VALUES ('$name','$designation','$position')";
...
<div class="container">
   ...
   <div class="admin-product-form-container">
      ...
      <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
         ...
         <input type="text" placeholder="enter position" name="position" class="box"></input>
         ...
         <?php
           ...
           ?>
            ...
            <a href="committee_update.php?edit=<?php echo $post['sno'];?>" class="btn"><i class="fas fa-trash"></i>
               ...
               <a href="bod_cms.php?delete=<?php echo $post['sno'];?>" class="btn"><i class="fas fa-trash"></i>delete</a>

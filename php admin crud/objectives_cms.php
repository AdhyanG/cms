...
session_start();
 if(isset($_POST['add_content'])){
  ...
  if(empty($content)){
      ...
      $insert = "INSERT INTO `objectives` (`objectives_content`) VALUES ('$content')";
 ...
 if(isset($_GET['delete'])){
   $id = $_GET['delete'];
    mysqli_query($db, "DELETE FROM objectives WHERE id= $id");
   header('location:objectives_cms.php');
};
   ...
   <div class="product-display">
      <table class="product-display-table">
         ...
         <?php
           ...
           ?>
            <tr>
            <td><?=$post['objectives_content']?></td>
            <td></td>
        
            <td>
               <a href="admin_update.php?edit=<?php echo $post['id'];?>" class="btn"><i class="fas fa-edit"></i>edit</a>
               <a href="objectives_cms.php?delete=<?php echo $post['id'];?>" class="btn"><i class="fas fa-trash"></i>delete</a>

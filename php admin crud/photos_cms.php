...
if(isset($_POST['add_product'])){
   ...
   if(empty($product_name)  || empty($product_image)){
      ...
      $insert = "INSERT INTO photos(product_name,  product_image) VALUES('$product_name', '$product_image')";
...
if(isset($_GET['delete'])){
   ...
   header('location:photos_cms.php');
};
...
<div class="container">
   ...
   <div class="admin-product-form-container">
      ...
      <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
         ...
         <input type="text" placeholder="enter photo name" name="product_name" class="box">
   ...
   <?php
   $sno=1;
   $select = mysqli_query($db, "SELECT * FROM photos");
      ...
      <table class="product-display-table">
         ...
         <tr>
          <td><?=$sno++;?></td>
            ...
            <td>
               <a href="photos_cms.php?edit=<?php echo $row['id']; ?>" class="btn"> <i class="fas fa-edit"></i> edit </a>
               <a href="photos_cms.php?delete=<?php echo $row['id']; ?>" class="btn"> <i class="fas fa-trash"></i> delete </a>
            </td>
         </tr>
      <?php } ?>
      </table>

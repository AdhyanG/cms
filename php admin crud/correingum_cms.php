...
include './correingum_upload.php';
session_start();

 if(isset($_GET['delete'])){
   $id = $_GET['delete'];
    mysqli_query($db, "DELETE FROM correingum WHERE sno= $id");
   header('location:correingum_cms.php');
};
...
<div class="container">
   ...
   <div class="admin-product-form-container">
      ...
      <form action="./correingum_upload.php" method="post" enctype="multipart/form-data">
         <h3>Corrigendum</h3>
         ...
         <?php
           ...
           ?>
            ...
            <td>
               ...
               <a href="correingum_cms.php?delete=<?php echo $post['sno'];?>" class="btn"><i class="fas fa-trash"></i>delete</a>

                ...
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            ...
                            <a href="correingum.php" class="dropdown-item">Correingum</a>
        ...
        <div class="container-fluid  py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Corrigendum</h1>
                    <a href="" class="h5 text-white">Notifications</a>
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">Corrigendum</a>
                </div>
            </div>
               ...
               <td class=""><?=$sno++;?></td>
                ...
                <td class=""><?=$post['notification_title']?></td>
                    <td class="">
                        ...
                        <a rel="" target="" 
                        href="./php admin crud/correingum_download.php?file_id=<?php echo $post['sno']?>" 
